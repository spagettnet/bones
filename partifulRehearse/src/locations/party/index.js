export const config = {
  ...
  music: {
    ...
    lfoDepth: 120,
    musicVolume: 0.35,
    // C minor pentatonic arpeggio (C4, Eb4, F4, G4, Bb4, C5)
    arpNotes: [261.63, 311.13, 349.23, 392.00, 466.16, 523.25],
    // Minor melodic phrases
    melodyPhrases: [
...
export { buildApartment as buildEnvironment } from './environment.js';
